...
| ツール | 状態 | 成果報酬 | EPC | 確定率 |
|---|---|---|---|---|
| freee予約 | 提携中(2026-08-27) / **リンク撤去中** | 新規会員登録完了 **¥3,000** | **32.48** | 100% |
| カラーミーショップ | 提携中(2026-08-12) | 新規登録 ¥800 / 新規契約 **¥5,000**(レギュラー)・**¥10,000**(ラージ) | 0.15 | 84.21% |
| BASE | 提携中(2026-08-12) | 新規登録 **¥400**（月20件以上で翌月¥500 / 50件¥600 / 100件¥800） | 3.1 | 97.17% |
| minne | 提携中(2026-08-12) | 新規クリエイター登録 **¥100** / 新規食品販売登録 ¥300 | — | 100% |
| ラクスル | **承認待ち**(申請2026-08-12) | 注文(税抜)の5% | 13.92 | 92.44% |

**単価とEPCが逆相関している。** 単価最高はカラーミーの新規契約(¥5,000〜10,000)だが EPC 0.15 は
クリック100回で15円の水準で、実質的に成約していない。BASE は単価¥400でも EPC 3.1 と約20倍あり、
**クリックあたりの期待値では BASE が上回る。** チェックリストの「ショップを作る」章に BASE を置いたのはこの理由。

freee予約は EPC 32.48・確定率100%・¥3,000 で4件中最良だが、商品がネット予約システムであり、
本サイトの読者（ハンドメイド作家・個人EC運営者）の主要な用途と一致しない。
**再掲載するなら「予約を受け付ける仕事」の文脈を作ってから。** 既存の章に差すと広告文と実態のズレを再生産する。
なお「スマホ最適化」プログラムのためPC非対応。
